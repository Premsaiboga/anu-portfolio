...
Project detail views use a landscape two-page book interface with real page-turn animation. The viewer uses the original portfolio page artwork from `public/assets/pages/`, supports previous/next navigation, keyboard arrow controls, thumbnails, zoom and fullscreen.

The portfolio download is `public/assets/portfolio-landscape.pdf`, a landscape A4 version with two original portfolio pages arranged side-by-side on each PDF page.
